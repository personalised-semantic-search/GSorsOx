 ...
 * @version 1.0
 */
public class GroupPreferencesTestAux extends TestCase {
	...
	public void testFORewriting() throws Exception {
		...
		for (AggregateStrategy strategyQA : str) {
			...
			final CSVWriter cacheSummaryWriter = new CSVWriter(new FileWriter(
					cacheSummaryFile), ',');
			...
			final CSVWriter memorySummaryWriter = new CSVWriter(new FileWriter(
					memorySummaryFile), ',');
