 ...
 * @version $Revision$
 */
public class CombinationAlgorithmsTests extends TestCase {
	...
	public static Test suite() {
		return new TestSuite(CombinationAlgorithmsTests.class,
				CombinationAlgorithmsTests.class.getSimpleName());
	}
...
//		System.out.print(probModel.size());
	...
	public void testcombPrefsPT() throws NumberFormatException, IOException {
		 ...
		 probModel);
		 PreferencesGraph pg3 = CombinationAlgorithms.combPrefsPT(pg1,
		 probModel, 0.3);
