...
public interface IEvaluationStrategy {
    ...
    IRelation evaluateQuery(IQuery query, List<IVariable> outputVariables)
	    ...
	    EvaluationException;
    public IRelation evaluateQuery(final IQuery query, final List<IVariable> outputVariables, JsonArray preferences, int k, MergingStrategy strategy)
    		throws ProgramNotStratifiedException, RuleUnsafeException,
    	    EvaluationException, FileNotFoundException;
